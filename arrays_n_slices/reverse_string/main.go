...
// varian: using [] int for runes (necessary for Unicode-strings!):
...
func main() {
	...
	fmt.Printf("The reserverd string using variant 1 is -%s-\n", reverse1(str))
	fmt.Printf("The reserverd string using variant 2 is -%s-\n", reverse2(str))
	fmt.Printf("The reserverd string using variant 3 is -%s-\n", reverse3(str))
}
